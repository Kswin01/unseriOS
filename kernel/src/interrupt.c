...
void enable_timer_irq(uint64_t gic_rdist_regs) {
    printf("Hacky enabling of timer IRQ!\n");
...
void init_gic_v3(uint64_t gic_dist_regs, uint64_t gic_rdist_regs) {
    ...
    printf("Initialising GIC redistributor...\n");
